...
//import com.shopme.common.entity.Inventory;
...
public class ProductService {
	public static final int PRODUCTS_PER_PAGE = 15;
...
//
//	public ProductService(ProductRepository repo, InventoryRepository inventoryRepository) {
//
//		this.repo = repo;
...
//		}
	...
	public String updateStockCount(Integer productId, Integer stock) throws ProductNotFoundException {
		...
		try {
			...
			Integer currentStock = Integer.valueOf(product.getStock());
			newStock = currentStock + stock;
			if (newStock > 0) {
				repo.updateStockStatus(productId, true);
			} else if (newStock <= 0){
				repo.updateStockStatus(productId, false);
			}
			repo.updateStockCount(productId, String.valueOf(newStock));
